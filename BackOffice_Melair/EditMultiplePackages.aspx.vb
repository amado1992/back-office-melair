Public Class EditMultiplePackages
  ...
  Private Sub completeData()
    ...
    notIncludedField.Text = package.notIncluded
        ...
        flightCheckBox.Checked = package.Flight
        transferCheckBox.Checked = package.Transfer
        hotelCheckBox.Checked = package.Hotel
        descripNavio.Text = package.ShipDescription
  ...
  End Sub
    ...
    Protected Sub fillFlightsModal(flight As MelairFlight)
        ...
        textFlightCityDest.Text = flight.cityDest
    ...
    Protected Sub fillFlightsSession(flight As MelairFlight)
        ...
        flight.cityDest = textFlightCityDest.Text
        Session("flight") = flight
    End Sub
  ...
  End Function
    ...
    Private Function makeFlightColumnsToUpdate() As Dictionary(Of String, String)
        ...
        End If
        If selectFlightCityDest.Checked Then
            flight.cityDest = Trim(textFlightCityDest.Text)
            flightColumnsToUpdate.Add("CityDest", flight.cityDest)
        End If
    ...
    End If
        ...
        If (descNavCheckBox.Checked = True) Then
            packageColumnsToUpdate.Add("ShipDescription", shipDescription)
        End If

        packageColumnsToUpdate.Add("Flight", flightCheckBox.Checked)
        packageColumnsToUpdate.Add("Transfer", transferCheckBox.Checked)
        packageColumnsToUpdate.Add("Hotel", hotelCheckBox.Checked)
