        ...
        <div class="row-table">
            ...
            <div style="margin-left: 25px;">
                <div class="entryDataClass">
                    ...
                    <div>
                        <asp:CheckBox ID="descNavCheckBox" runat="server" />
                        <label>
                            Descrição navio</label>
                        <asp:TextBox Width="425px" ID="descripNavio" runat="server" TextMode="MultiLine" CssClass="form-control" />
                    </div>
                </div>
                ...
                <style>
                    ...
                    <table style="width: 100%">
                            ...
                            <td>
                                <div class="entryDataClass">
                                    ...
                                    <asp:DropDownList ID="listFlightCompany" runat="server" AutoPostBack="true" OnTextChanged="refreshLogo"
                                        ...
                                        <asp:ListItem Text="Iberia" Value="3" />
                                    </asp:DropDownList>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="entryDataClass">
                                    <asp:CheckBox ID="selectFlightCityDest" runat="server" CssClass="editMultiplePackagesCheckBox" />
                                    <label>
                                        Cidade DESTINO:</label>
                                    <asp:TextBox ID="textFlightCityDest" runat="server" CssClass="form-control" />
                                </div>
                            </td>
                        </tr>
                        <tr>
