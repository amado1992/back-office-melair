...
Public Class SQL
  ...
  End Function
    ...
    Public Function insertPackage(packageData As Array) As String
        ...
        Dim description, company, logo, city, flightCode, flightDate, flightTime, flightTaxes, returnFlight, returnFlightTime, flightTransfer, flightHotel, offerDescription, status As String
                ...
                For i As Integer = 0 To howManyDates - 1
                    ...
                    For rowIndex As Integer = 0 To flightsData.Count - 1
                        ...
                        For itemIndex As Integer = 0 To detailsData.Item(rowIndex).Count - 1
                            ...
                            query = "INSERT INTO " & connTable & " VALUES (" & packId & ", '" & description & "', '" & company & "', '" & logo & "', '" & city & "', '" & flightCode & "', '" & flightDate & "', '" & flightTime & "', " & flightTaxes & ", '" & returnFlight & "','" & returnFlightTime & "', '" & flightTransfer & "', '" & flightHotel & "', '" & offerDescription & "', " & cabinsPerCity & ", '" & status & "')"
                            sqlCmd.CommandText = query
                            rowsReturned = sqlCmd.ExecuteNonQuery()
                            If rowsReturned = 0 Then
                                ' Fallo
    ...
    Private Sub insertFromAuxTables()
        ...
        Try
            ...
            sqlCmd.CommandText = query
            sqlCmd.ExecuteNonQuery()
            query = "INSERT INTO " & connTable & " (idPack, idFlight, Description, Company, Logo, City, FlightCode, FlightDate, FlightTime, FlightTaxes, ReturnFlight, ReturnFlightTime, FlightTransfer, FlightHotel, OfferDescription, CabinsPerCity, FlightStatus) "
            query &= "SELECT idPack, idFlight, Description, Company, Logo, City, FlightCode, FlightDate, FlightTime, FlightTaxes, ReturnFlight, ReturnFlightTime, FlightTransfer, FlightHotel, OfferDescription, CabinsPerCity, FlightStatus FROM " & connTable & "Aux"
            sqlCmd.CommandText = query
            sqlCmd.ExecuteNonQuery()
            query = "SET IDENTITY_INSERT " & connTable & " OFF"
            sqlCmd.CommandText = query
  ...
  Public Function editPackage(packageData As Array) As String
    ...
    Dim company, logo, city, description, flightCode, flightDate, flightTime, flightTaxes, returnFlight, returnFlightTime, flightTransfer, flightHotel, offerDescription, status As String
    ...
    Try
      ...
      For flightIndex As Integer = 0 To flightsData.Count - 1
        If flightsData.Item(flightIndex).Item("Company") <> "" Then
          ...
          connTable = ConfigurationManager.AppSettings.Get("MelairFlights") & "Aux"
          query = "INSERT INTO " & connTable & " VALUES (" & nextPackId & ", " & nextFlightId & ", '" & description & "', '" & company & "', '" & logo & "', '" & city & "', '" & flightCode & "', '" & flightDate & "', '" & flightTime & "', " & flightTaxes & ", '" & returnFlight & "','" & returnFlightTime & "', '" & flightTransfer & "', '" & flightHotel & "', '" & offerDescription & "', " & cabinsPerCity & ", '" & status & "')"
          sqlCmd.CommandText = query
          sqlCmd.ExecuteNonQuery()
