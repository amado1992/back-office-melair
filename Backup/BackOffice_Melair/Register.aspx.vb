Public Class Register1
    ...
    Private Function rowIsFilled(Optional rowIndex As Integer = -1) As Boolean
        ...
        Dim descField, numField, quotaField As TextBox
        ...
        If rowIndex <> -1 Then
            ...
            numField = CType(gridView.Rows(rowIndex).Cells(3).FindControl("numField"), TextBox)
        ...
        If rowIsFilled() Then
            If Not Session("dataBackup") Is Nothing Then
                ...
                If dtCurrentTable.Rows.Count > 0 Then
                    Dim comp, logo, city, desc, num, quota, status As String
    ...
    Protected Sub showDetails(sender As Object, e As EventArgs)
        ...
        If rowIsFilled(rowIndex) Then
            Dim numField As TextBox = CType(gridView.Rows(rowIndex).Cells(3).FindControl("numField"), TextBox)
